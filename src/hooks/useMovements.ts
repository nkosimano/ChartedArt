...
export const useMovementMetrics = (movementId: string, autoRefresh = true) => {
  ...
  const fetchMetrics = useCallback(async () => {
    try {
      ...
      const response = await fetch(`/api/movements/${movementId}/progress`);
  ...
  }, [movementId, autoRefresh, fetchMetrics]);
