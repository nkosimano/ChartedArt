-- Execute this SQL in your Supabase SQL Editor to create the missing functions
-- This will fix the 404 errors for get_business_overview and other RPC functions

-- Create the get_business_overview RPC function
