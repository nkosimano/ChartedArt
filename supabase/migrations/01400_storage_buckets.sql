-- ============================================
-- Migration: 01400_storage_buckets.sql
-- Description: Supabase storage buckets for file uploads
-- Dependencies: 00300_admin_system.sql (for admin_users table)
-- ============================================

-- Rollback:
-- DELETE FROM storage.buckets WHERE id IN ('product-images', 'artwork-images');
...
-- =====================================================
-- Note: Storage buckets for product images (10MB limit) and legacy artwork images
