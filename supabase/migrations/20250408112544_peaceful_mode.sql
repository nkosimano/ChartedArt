/*
  ...
  1. Changes
    ...
    - Create function to update product quantity with admin check
    - Add updated_at column to products table

  2. Security
    - Function is SECURITY DEFINER to run with elevated privileges
    - Checks if user is admin before allowing quantity updates
*/

-- Add quantity and updated_at columns to products table
